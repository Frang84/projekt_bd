...
VALUES  ('Favorite',1, 100, 4.19,'Karmex'),
		...
		('Feringa karma mokra dla koci?t',2,120,29.0,'POL-KARM')
...
VALUES  (NULL, 132201834 ,43 ,' NADIA ',' MICHALSKI ',		'106325829852' ),
		...
		(NULL, 183621047 ,28 ,' PIOTR ',' WOJCIECHOWSKI ',  '491459719762' ),
		(NULL, 642261573 ,18 ,' KRZYSZTOF ',' OLSZEWSKI ',  '428977938803' ),
		...
		(NULL, 744730983 ,41 ,' HANNA ',' JANKOWSKI ',	    '703878799248' ),
...
(NULL, 946390123 ,53 ,' PAWE? ',' OPALA ' ),
(NULL, 237920370 ,52 ,' MICHA? ',' ADAMIK ' ),
